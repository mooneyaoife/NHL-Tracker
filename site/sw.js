const CACHE="nhl-tracker-6.17.0";
const SHELL=["./","./index.html","./styles.css?v=6.0.0","./theme-569.css?v=6.0.0","./design-system.css?v=6.17.0","./app.js?v=6.17.0","./manifest.webmanifest","./icons/icon.svg?v=6.0.0","./icons/icon-192.png","./icons/icon-512.png","./data/tracker.json","./data/tracker-models.json","./data/puckpedia-mail.json","./data/seasons/index.json","./vendor/plotly-2.35.2.min.js"];
