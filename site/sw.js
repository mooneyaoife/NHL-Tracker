const CACHE="nhl-tracker-7.38.1";
...
const SHELL=["./","./index.html","./critical.css?v=7.38.1","./core-routes.css?v=7.38.1","./freshness-status.js?v=7.38.1","./shell.js?v=7.38.1","./home-snapshot.js?v=7.38.1","./game-state.js?v=7.38.1","./data-contracts.js?v=7.38.1","./data-loader.js?v=7.38.1","./route-loader.js?v=7.38.1","./route-app.js?v=7.38.1","./routes/night.js?v=7.38.1","./routes/season.js?v=7.38.1","./cloudflare-live.js?v=7.38.1","./manifest.webmanifest","./icons/icon.svg?v=7.0.1","./icons/icon-192.png","./icons/icon-512.png","./build-meta.json","./data/home.json","./data/tracker-manifest.json","./data/tracker-core.json","./data/tracker-schedule.json"];
