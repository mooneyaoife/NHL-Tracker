const CACHE="nhl-tracker-5.17.0";
const SHELL=["./","./index.html","./styles.css?v=5.17.0","./app.js?v=5.17.0","./manifest.webmanifest","./icons/icon-192.png","./icons/icon-512.png","./data/tracker.json","./data/seasons/index.json","./vendor/plotly-2.35.2.min.js"];
