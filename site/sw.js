const CACHE="nhl-tracker-5.68.0";
const SHELL=["./","./index.html","./styles.css?v=5.68.0","./app.js?v=5.68.0","./manifest.webmanifest","./icons/icon-192.png","./icons/icon-512.png","./data/tracker.json","./data/tracker-models.json","./data/puckpedia-mail.json","./data/seasons/index.json","./vendor/plotly-2.35.2.min.js"];
