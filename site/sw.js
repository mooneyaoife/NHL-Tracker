const CACHE="nhl-tracker-5.30.3";
const SHELL=["./","./index.html","./styles.css?v=5.30.3","./app.js?v=5.30.3","./manifest.webmanifest","./icons/icon-192.png","./icons/icon-512.png","./data/tracker.json","./data/seasons/index.json","./vendor/plotly-2.35.2.min.js"];
