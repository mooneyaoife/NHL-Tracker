const CACHE="nhl-tracker-7.22.1";
const LEGACY_CACHE="nhl-tracker-7.21.0";
...
const SHELL=["./","./index.html","./critical.css?v=7.22.1","./styles.css?v=6.0.0","./theme-569.css?v=6.0.0","./design-system.css?v=7.22.1","./freshness-status.js?v=7.22.1","./statistics.js?v=7.22.1","./shell.js?v=7.22.1","./game-state.js?v=7.22.1","./data-contracts.js?v=7.22.1","./data-loader.js?v=7.22.1","./router.js?v=7.22.1","./route-loader.js?v=7.22.1","./route-app.js?v=7.22.1","./routes/night.js?v=7.22.1","./routes/season.js?v=7.22.1","./preferences.js?v=7.22.1","./live-updates.js?v=7.22.1","./observability.js?v=7.22.1","./cloudflare-live.js?v=7.22.1","./app.js?v=7.22.1","./manifest.webmanifest","./icons/icon.svg?v=7.0.1","./icons/icon-192.png","./icons/icon-512.png","./build-meta.json","./data/home.json","./data/tracker-manifest.json","./data/tracker-core.json","./data/tracker-schedule.json"];
