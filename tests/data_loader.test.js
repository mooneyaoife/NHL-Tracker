...
(async()=>{
  ...
  assert.deepEqual(loader.forRoute("teams"),["core","calendar","players","analytics"]);
  assert.deepEqual(loader.forRoute("availability"),["core","calendar","players"]);
  assert.deepEqual(loader.forRoute("power"),["core","analytics"]);
  delete require.cache[loaderPath];
