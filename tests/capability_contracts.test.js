...
const valid={schema:1,capabilities:Object.fromEntries(["core","calendar","schedule","players","analytics"].map(name=>[name,{url:`data/tracker-${name}.json`,bytes:100,sha256:"a".repeat(64)}]))};
...
assert.deepEqual(contracts.validateCapabilityData("calendar",{games:[]}),[]);
